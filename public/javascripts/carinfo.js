...
function applyIntentCar(carId) {
    ...
    if (userInfo.usertype == 1) {
        getEnterpriseByUserId(userInfo.userid, function (result) {
            enterprise = result;
            if (!enterprise || !carInfo || carInfo.attrs.eid == enterprise.enterpriseid) {
        ...
        getDriver(userInfo.userid, function (result) {
            user = result.user;
            if (!carInfo || carInfo.attrs.createrid == user.userid) {
...
function viewConcatInfo() {
    ...
    box_html += ' <p class="box_p"><span class="box_tel">公司名称：</span><span class="box_addr">衡阳雁城物流园</span></p>';
    box_html += '   <p class="box_p"><span class="box_tel">联系电话：</span><span class="center_tel1">0734-2999999</span></p>';
    box_html += ' <p class="box_p"><span class="box_tel">地址：</span><span class="box_addr">湖南省衡阳市石鼓区松木经济开发区</span></p>';
